...
#                                       bTag = cms.string(flashggBTag),
                                       ...
                                       #######################################################
                                       #######################################################
                                       #with this dirty trick I use only the default tth categories without the pt splitting
                                       STXSPtBoundaries_pt1 = cms.vdouble(0,13001),
                                       STXSPtBoundaries_pt2 = cms.vdouble(-1,-1),
                                       STXSPtBoundaries_pt3 = cms.vdouble(-1,-1),
                                       STXSPtBoundaries_pt4 = cms.vdouble(-1,-1),
                                       Boundaries_pt1 = cms.vdouble(0.986025, 0.9948537, 0.9983046, 0.9990729),
                                       Boundaries_pt2 = cms.vdouble(-999,-999),
                                       Boundaries_pt3 = cms.vdouble(-999,-999),
                                       Boundaries_pt4 = cms.vdouble(-999,-999),
                                       #######################################################
                                       #######################################################
...
flashggTTHLeptonicTag = cms.EDProducer("FlashggTTHLeptonicTagProducer",
                                       ...
                                       STXSPtBoundaries_pt3 = cms.vdouble(-1,-1),
                                       STXSPtBoundaries_pt4 = cms.vdouble(-1,-1),
                                       MVAThreshold_pt1 = cms.vdouble(0.8997816, 0.95635754, 0.9725133, 0.9870608),
                                       MVAThreshold_pt2 = cms.vdouble(-999,-999),
                                       MVAThreshold_pt3 = cms.vdouble(-999,-999),
                                       MVAThreshold_pt4 = cms.vdouble(-999,-999),
                                       tthVstHThreshold = cms.double(-999), # 97% ttH eff
                                       #######################################################
                                       #######################################################
                                       PhoMVAThreshold = cms.double(-0.7), 
