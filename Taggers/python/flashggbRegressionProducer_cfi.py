...
#############################################temporary fix for 2016 files in 9 4 X ############################################################ 
                                    #       bRegressionWeightfile_2017= cms.untracked.string(os.environ["CMSSW_BASE"]+"/src/flashgg/Taggers/data/DNN_models/model-18.pb"), 
                                    #       y_mean_2017 = cms.untracked.double(1.0454729795455933),
                                    #       y_std_2017 =cms.untracked.double( 0.31628304719924927),
                                           )
