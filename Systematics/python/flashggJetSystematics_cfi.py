...
def createJECESource(process):
    ...
    process.jec = cms.ESSource("PoolDBESSource",
        ...
        #  tag    = cms.string('JetCorrectorParametersCollection_Fall17_17Nov2017_V8_MC_AK4PFchs'),       
...
def createJERESource(process):
    ...
    process.jer = cms.ESSource("PoolDBESSource",
        ...
        cms.PSet(
         ...
         # tag    = cms.string('JR_Fall17_17Nov2017_V8_MC_PtResolution_AK4PFchs'),
        ...
        cms.PSet(
         ...
         # tag    = cms.string('JR_Fall17_17Nov2017_V8_MC_SF_AK4PFchs'),          
          label  = cms.untracked.string('AK4PFchs')
          ),
        ),
