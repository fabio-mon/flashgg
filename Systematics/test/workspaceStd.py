...
if customize.doFiducial:
    ...
    HHtagList = hhc.tagList(customize,process)
    for HHtag in HHtagList:
        tagList.append(HHtag)
    print "taglist is:"
    print tagList
...
process.flashggMetSystematics.src = cms.InputTag("flashggMetsCorr")
#process.flashggMetSystematics.src = cms.InputTag("flashggMets")
...
if customize.doBJetRegression:
    ...
    flashggDoubleHTag.doCategorization=cms.bool(True)
    flashggDoubleHTag.METTag=cms.InputTag('flashggMetsCorr')
    #flashggDoubleHTag.METTag=cms.InputTag('flashggMets')
